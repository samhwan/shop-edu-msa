...
public class Inventory {
    ...
    public static void decreasedInventory(DeliveryStarted deliveryStarted) {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void decreasedInventory(OrderPlaced orderPlaced) {
        //implement business logic here:
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increasedInventory(DeliveryCanceled deliveryCanceled) {
        //implement business logic here:
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increasedInventory(OrderCanceled orderCanceled) {
        //implement business logic here:
